...
Reads DATABASE_URL from the application's own settings (so there's one source of
truth for the connection string) and runs migrations against the async engine.
"""
import asyncio
